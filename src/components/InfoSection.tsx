      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div>
          ...
          <p className="text-lg text-gray-dark mb-6">
            We are constantly expanding the range of 2D animations and rhymes offered, engaging children of all ages. 
            Our goal is to carefully educate and develop them in a fun way. We strive to turn the learning process into 
            a bright event so that children watch with pleasure.
          </p>

          {/* Bullet Points */}
          <ul className="space-y-3">
            <li className="flex items-start gap-2">
              <FontAwesomeIcon icon={faCheckCircle} className="text-secondary mt-1" />
              <span>Comprehensive cartoon library for individualized learning</span>
            </li>
            <li className="flex items-start gap-2">
              <FontAwesomeIcon icon={faCheckCircle} className="text-secondary mt-1" />
