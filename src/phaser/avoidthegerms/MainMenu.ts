// src/phaser/avoidthegerms/MainMenu.ts
...
export default class MainMenu extends Phaser.Scene {
    ...
    create(): void {
        this.music = this.sound.play('music', { loop: true }) as Phaser.Sound.BaseSound;
    ...
    addGerm(area: Phaser.Geom.Rectangle, animation: string): void {
